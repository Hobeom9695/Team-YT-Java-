...
//	}
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.jdbcAuthentication().dataSource(dataSource)
				.usersByUsernameQuery("select id as userName, password, enabled" + " from user_yt where id = ?")
				.authoritiesByUsernameQuery("select id as userName, authority" + " from user_yt where id = ?")
